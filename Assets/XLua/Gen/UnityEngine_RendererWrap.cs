...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRendererWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "lightProbeProxyVolumeOverride",
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "lightProbeProxyVolumeOverride",
            ...
            try
            {
                ...
                if (gen_param_count == 2 && translator.Assignable<UnityEngine.MaterialPropertyBlock>(L, 2))
                {
                    UnityEngine.MaterialPropertyBlock _properties =
                        (UnityEngine.MaterialPropertyBlock)translator.GetObject(L, 2,
                ...
                if (gen_param_count == 3 && translator.Assignable<UnityEngine.MaterialPropertyBlock>(L, 2) &&
            ...
            try
            {
...

                {
                    System.Collections.Generic.List<UnityEngine.Material> _m =
                        (System.Collections.Generic.List<UnityEngine.Material>)translator.GetObject(L, 2,
        ...
        static int _m_SetSharedMaterials(RealStatePtr L)
        {
            try
            {
                ...
                {
                    System.Collections.Generic.List<UnityEngine.Material> _materials =
                        (System.Collections.Generic.List<UnityEngine.Material>)translator.GetObject(L, 2,
                            typeof(System.Collections.Generic.List<UnityEngine.Material>));
        ...
        static int _s_set_lightProbeProxyVolumeOverride(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.lightProbeProxyVolumeOverride =
                    (UnityEngine.GameObject)translator.GetObject(L, 2, typeof(UnityEngine.GameObject));
            }
            catch (System.Exception gen_e)
            {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
        ...
        static int _s_set_materials(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.materials =
                    (UnityEngine.Material[])translator.GetObject(L, 2, typeof(UnityEngine.Material[]));
            }
            catch (System.Exception gen_e)
            {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
        ...
        static int _s_set_sharedMaterial(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.sharedMaterial =
                    (UnityEngine.Material)translator.GetObject(L, 2, typeof(UnityEngine.Material));
            }
            catch (System.Exception gen_e)
            {
        ...
        static int _s_set_sharedMaterials(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.sharedMaterials =
                    (UnityEngine.Material[])translator.GetObject(L, 2, typeof(UnityEngine.Material[]));
            }
            catch (System.Exception gen_e)
            {
