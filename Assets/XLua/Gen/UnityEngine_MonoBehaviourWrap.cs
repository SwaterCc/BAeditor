    ...
    public class UnityEngineMonoBehaviourWrap
    {
            ...
            try
            {
                ...
                if (gen_param_count == 2 && translator.Assignable<System.Collections.IEnumerator>(L, 2))
                {
                    System.Collections.IEnumerator _routine =
                        (System.Collections.IEnumerator)translator.GetObject(L, 2,
        ...
        static int _m_StopCoroutine(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Coroutine _routine =
                        (UnityEngine.Coroutine)translator.GetObject(L, 2, typeof(UnityEngine.Coroutine));
