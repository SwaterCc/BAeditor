...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "AllocateAxisOfRotationAttribute",
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "proceduralSimulationSupported",
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "SetMaximumPreMappedBufferCounts",
        ...
        static int _m_SetParticles(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.ParticleSystem gen_to_be_invoked =
                    (UnityEngine.ParticleSystem)translator.FastGetCSObj(L, 1);
                ...
                if (gen_param_count == 2 && translator.Assignable<UnityEngine.ParticleSystem.Particle[]>(L, 2))
                {
                    UnityEngine.ParticleSystem.Particle[] _particles =
                        (UnityEngine.ParticleSystem.Particle[])translator.GetObject(L, 2,
                ...
                if (gen_param_count == 2 &&
                    translator.Assignable<Unity.Collections.NativeArray<UnityEngine.ParticleSystem.Particle>>(L, 2))
                {
                ...
                if (gen_param_count == 3 && translator.Assignable<UnityEngine.ParticleSystem.Particle[]>(L, 2) &&
                ...
                if (gen_param_count == 4 && translator.Assignable<UnityEngine.ParticleSystem.Particle[]>(L, 2) &&
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4))
                {
                    UnityEngine.ParticleSystem.Particle[] _particles =
                        (UnityEngine.ParticleSystem.Particle[])translator.GetObject(L, 2,
                            typeof(UnityEngine.ParticleSystem.Particle[]));
            ...
            try
            {
...

                {
                    System.Collections.Generic.List<UnityEngine.Vector4> _customData =
                        (System.Collections.Generic.List<UnityEngine.Vector4>)translator.GetObject(L, 2,
        ...
        static int _m_Simulate(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) &&
                ...
                if (gen_param_count == 4 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) &&
                    LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4))
                {
                    float _t = (float)LuaAPI.lua_tonumber(L, 2);
                    bool _withChildren = LuaAPI.lua_toboolean(L, 3);
                ...
                if (gen_param_count == 5 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) &&
                    LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4) &&
        ...
        static int _m_Emit(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 3 && translator.Assignable<UnityEngine.ParticleSystem.EmitParams>(L, 2) &&
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
                {
        ...
        static int _m_TriggerSubEmitter(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator
                        .Assignable<System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle>>(L, 3))
                {
                    int _subEmitterIndex = LuaAPI.xlua_tointeger(L, 2);
                    System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle> _particles =
                        (System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle>)translator.GetObject(L, 3,
