    ...
    public class SystemCollectionsGenericList_1_SystemInt32_Wrap
    {
            ...
            try
            {
                    ...
                    translator.Assignable<System.Collections.Generic.IEnumerable<int>>(L, 2))
                {
                    System.Collections.Generic.IEnumerable<int> _collection =
                        (System.Collections.Generic.IEnumerable<int>)translator.GetObject(L, 2,
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
            try
            {
                ...
                if (translator.Assignable<System.Collections.Generic.List<int>>(L, 1) &&
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
            ...
            {
                if (translator.Assignable<System.Collections.Generic.List<int>>(L, 1) &&
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
                {
                    System.Collections.Generic.List<int> gen_to_be_invoked =
                        (System.Collections.Generic.List<int>)translator.FastGetCSObj(L, 1);
            ...
            try
            {
                    ...
                    translator.Assignable<System.Collections.Generic.IComparer<int>>(L, 3))
                {
                    ...
                    System.Collections.Generic.IComparer<int> _comparer =
                        (System.Collections.Generic.IComparer<int>)translator.GetObject(L, 3,
                    ...
                    translator.Assignable<System.Collections.Generic.IComparer<int>>(L, 5))
                {
                    ...
                    System.Collections.Generic.IComparer<int> _comparer =
                        (System.Collections.Generic.IComparer<int>)translator.GetObject(L, 5,
                            typeof(System.Collections.Generic.IComparer<int>));
        ...
        static int _m_CopyTo(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 3 && translator.Assignable<int[]>(L, 2) &&
                ...
                if (gen_param_count == 5 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) &&
                    translator.Assignable<int[]>(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) &&
        ...
        static int _m_FindIndex(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 4 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) &&
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && translator.Assignable<System.Predicate<int>>(L, 4))
                {
                    int _startIndex = LuaAPI.xlua_tointeger(L, 2);
                    int _count = LuaAPI.xlua_tointeger(L, 3);
        ...
        static int _m_InsertRange(RealStatePtr L)
        {
            try
            {
...

                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                    System.Collections.Generic.IEnumerable<int> _collection =
                        (System.Collections.Generic.IEnumerable<int>)translator.GetObject(L, 3,
                            typeof(System.Collections.Generic.IEnumerable<int>));
        ...
        static int _m_Sort(RealStatePtr L)
        {
            try
            {
                ...
                {
                    System.Collections.Generic.IComparer<int> _comparer =
                        (System.Collections.Generic.IComparer<int>)translator.GetObject(L, 2,
                            typeof(System.Collections.Generic.IComparer<int>));
                    ...
                    translator.Assignable<System.Collections.Generic.IComparer<int>>(L, 4))
                {
                    ...
                    int _count = LuaAPI.xlua_tointeger(L, 3);
                    System.Collections.Generic.IComparer<int> _comparer =
                        (System.Collections.Generic.IComparer<int>)translator.GetObject(L, 4,
                            typeof(System.Collections.Generic.IComparer<int>));
