...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineLightWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "useViewFrustumForShadowCasterCull",
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "useViewFrustumForShadowCasterCull",
        ...
        static int _m_AddCommandBuffer(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 3 && translator.Assignable<UnityEngine.Rendering.LightEvent>(L, 2) &&
                    translator.Assignable<UnityEngine.Rendering.CommandBuffer>(L, 3))
                {
                    ...
                    UnityEngine.Rendering.CommandBuffer _buffer =
                        (UnityEngine.Rendering.CommandBuffer)translator.GetObject(L, 3,
                ...
                if (gen_param_count == 4 && translator.Assignable<UnityEngine.Rendering.LightEvent>(L, 2) &&
                    translator.Assignable<UnityEngine.Rendering.CommandBuffer>(L, 3) &&
        ...
        static int _m_AddCommandBufferAsync(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 5 && translator.Assignable<UnityEngine.Rendering.LightEvent>(L, 2) &&
                    translator.Assignable<UnityEngine.Rendering.CommandBuffer>(L, 3) &&
                    translator.Assignable<UnityEngine.Rendering.ShadowMapPass>(L, 4) &&
