    ...
    public class UnityEngineTransformWrap
    {
        ...
        static int _m_SetParent(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 3 && translator.Assignable<UnityEngine.Transform>(L, 2) &&
        ...
        static int _m_Translate(RealStatePtr L)
        {
            try
            {
                    ...
                    translator.Assignable<UnityEngine.Transform>(L, 5))
                {
                    ...
                    float _y = (float)LuaAPI.lua_tonumber(L, 3);
                    float _z = (float)LuaAPI.lua_tonumber(L, 4);
                    UnityEngine.Transform _relativeTo =
                        (UnityEngine.Transform)translator.GetObject(L, 5, typeof(UnityEngine.Transform));
        ...
        static int _m_Rotate(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 4 && translator.Assignable<UnityEngine.Vector3>(L, 2) &&
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && translator.Assignable<UnityEngine.Space>(L, 4))
                {
                    UnityEngine.Vector3 _axis;
                    translator.Get(L, 2, out _axis);
                    float _angle = (float)LuaAPI.lua_tonumber(L, 3);
