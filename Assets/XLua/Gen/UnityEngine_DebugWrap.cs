    ...
    public class UnityEngineDebugWrap
    {
        ...
        static int _m_DrawLine_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 3 && translator.Assignable<UnityEngine.Vector3>(L, 1) &&
                    translator.Assignable<UnityEngine.Vector3>(L, 2) && translator.Assignable<UnityEngine.Color>(L, 3))
                {
                    UnityEngine.Vector3 _start;
                    translator.Get(L, 1, out _start);
                    UnityEngine.Vector3 _end;
                ...
                if (gen_param_count == 4 && translator.Assignable<UnityEngine.Vector3>(L, 1) &&
                    translator.Assignable<UnityEngine.Vector3>(L, 2) &&
                    translator.Assignable<UnityEngine.Color>(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4))
                {
                    UnityEngine.Vector3 _start;
                    translator.Get(L, 1, out _start);
                    UnityEngine.Vector3 _end;
                ...
                if (gen_param_count == 5 && translator.Assignable<UnityEngine.Vector3>(L, 1) &&
                    translator.Assignable<UnityEngine.Vector3>(L, 2) &&
                    translator.Assignable<UnityEngine.Color>(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) &&
        ...
        static int _m_Log_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 2 && translator.Assignable<object>(L, 1) &&
        ...
        static int _m_LogFormat_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count >= 1 && (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING) &&
                    (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 2) || translator.Assignable<object>(L, 2)))
                {
                ...
                if (gen_param_count >= 2 && translator.Assignable<UnityEngine.Object>(L, 1) &&
                    ...
                    (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 3) || translator.Assignable<object>(L, 3)))
                {
                    UnityEngine.Object _context =
                ...
                if (gen_param_count >= 4 && translator.Assignable<UnityEngine.LogType>(L, 1) &&
                    ...
                    (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 5) || translator.Assignable<object>(L, 5)))
                {
                    ...
                    UnityEngine.Object _context =
                        (UnityEngine.Object)translator.GetObject(L, 3, typeof(UnityEngine.Object));
            ...
            try
            {
                ...
                if (gen_param_count == 1 && translator.Assignable<System.Exception>(L, 1))
                {
                    System.Exception _exception =
                        (System.Exception)translator.GetObject(L, 1, typeof(System.Exception));
                ...
                if (gen_param_count == 2 && translator.Assignable<System.Exception>(L, 1) &&
                    translator.Assignable<UnityEngine.Object>(L, 2))
                {
                    System.Exception _exception =
                        (System.Exception)translator.GetObject(L, 1, typeof(System.Exception));
        ...
        static int _m_Assert_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 2 && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 1) &&
                    translator.Assignable<UnityEngine.Object>(L, 2))
                {
                    bool _condition = LuaAPI.lua_toboolean(L, 1);
                    UnityEngine.Object _context =
                ...
                if (gen_param_count == 3 && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 1) &&
                    translator.Assignable<object>(L, 2) && translator.Assignable<UnityEngine.Object>(L, 3))
                {
                    bool _condition = LuaAPI.lua_toboolean(L, 1);
                    object _message = translator.GetObject(L, 2, typeof(object));
                    UnityEngine.Object _context =
        ...
        static int _m_AssertFormat_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count >= 3 && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 1) &&
                    ...
                    (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 4) || translator.Assignable<object>(L, 4)))
                {
                    bool _condition = LuaAPI.lua_toboolean(L, 1);
                    UnityEngine.Object _context =
                        (UnityEngine.Object)translator.GetObject(L, 2, typeof(UnityEngine.Object));
