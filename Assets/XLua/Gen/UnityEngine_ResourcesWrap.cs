    ...
    public class UnityEngineResourcesWrap
    {
        ...
        static int _m_UnloadAsset_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Object _assetToUnload =
            ...
            try
            {
...

                {
                    ...
                    System.Collections.Generic.List<UnityEngine.Object> _objects =
                        (System.Collections.Generic.List<UnityEngine.Object>)translator.GetObject(L, 2,
        ...
        static int _m_InstanceIDsToValidArray_xlua_st_(RealStatePtr L)
        {
            try
            {
...

                {
                    Unity.Collections.NativeArray<int> _instanceIDs;
                    translator.Get(L, 1, out _instanceIDs);
                    Unity.Collections.NativeArray<bool> _validArray;
                    translator.Get(L, 2, out _validArray);
