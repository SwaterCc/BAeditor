...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineVector3Wrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "kEpsilonNormalSqrt",
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
                if (LuaAPI.lua_gettop(L) == 4 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) &&
                ...
                if (LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) &&
        ...
        static int __AddMeta(RealStatePtr L)
        {
            try
            {
                ...
                if (translator.Assignable<UnityEngine.Vector3>(L, 1) &&
        ...
        static int _m_RotateTowards_xlua_st_(RealStatePtr L)
        {
            try
            {
...

                {
                    ...
                    var gen_ret =
                        UnityEngine.Vector3.RotateTowards(_current, _target, _maxRadiansDelta, _maxMagnitudeDelta);
                    translator.PushUnityEngineVector3(L, gen_ret);
        ...
        static int _m_SmoothDamp_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 4 && translator.Assignable<UnityEngine.Vector3>(L, 1) &&
                    translator.Assignable<UnityEngine.Vector3>(L, 2) &&
                    translator.Assignable<UnityEngine.Vector3>(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4))
                {
                    UnityEngine.Vector3 _current;
                    translator.Get(L, 1, out _current);
                    UnityEngine.Vector3 _target;
                ...
                if (gen_param_count == 6 && translator.Assignable<UnityEngine.Vector3>(L, 1) &&
                    translator.Assignable<UnityEngine.Vector3>(L, 2) &&
                    translator.Assignable<UnityEngine.Vector3>(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) &&
        ...
        static int _m_ToString(RealStatePtr L)
        {
            try
            {
                ...
                {
                    string _format = LuaAPI.lua_tostring(L, 2);
                    System.IFormatProvider _formatProvider =
                        (System.IFormatProvider)translator.GetObject(L, 3, typeof(System.IFormatProvider));
