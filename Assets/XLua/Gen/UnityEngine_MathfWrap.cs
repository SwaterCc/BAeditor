...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineMathfWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "CorrelatedColorTemperatureToRGB",
        ...
        static int _m_Min_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1) &&
                ...
                if (gen_param_count >= 0 && (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 1) ||
        ...
        static int _m_Clamp_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1) &&
        ...
        static int _m_SmoothDamp_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 5 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1) &&
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) &&
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5))
                {
                    float _current = (float)LuaAPI.lua_tonumber(L, 1);
                    float _target = (float)LuaAPI.lua_tonumber(L, 2);
                    float _currentVelocity = (float)LuaAPI.lua_tonumber(L, 3);
                ...
                if (gen_param_count == 6 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1) &&
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) &&
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5) &&
        ...
        static int _m_SmoothDampAngle_xlua_st_(RealStatePtr L)
        {
            try
            {
                    ...
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4))
                {
                    ...
                    var gen_ret =
                        UnityEngine.Mathf.SmoothDampAngle(_current, _target, ref _currentVelocity, _smoothTime);
                    LuaAPI.lua_pushnumber(L, gen_ret);
                    LuaAPI.lua_pushnumber(L, _currentVelocity);
                    ...
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5))
                {
                    ...
                    var gen_ret = UnityEngine.Mathf.SmoothDampAngle(_current, _target, ref _currentVelocity,
                        _smoothTime, _maxSpeed);
                    LuaAPI.lua_pushnumber(L, gen_ret);
                    LuaAPI.lua_pushnumber(L, _currentVelocity);
                    ...
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6))
                {
                    ...
                    var gen_ret = UnityEngine.Mathf.SmoothDampAngle(_current, _target, ref _currentVelocity,
                        _smoothTime, _maxSpeed, _deltaTime);
                    LuaAPI.lua_pushnumber(L, gen_ret);
                    LuaAPI.lua_pushnumber(L, _currentVelocity);
