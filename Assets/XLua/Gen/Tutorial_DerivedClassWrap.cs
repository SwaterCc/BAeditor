    ...
    public class TutorialDerivedClassWrap
    {
        ...
        static int __AddMeta(RealStatePtr L)
        {
            try
            {
                ...
                if (translator.Assignable<Tutorial.DerivedClass>(L, 1) &&
                    translator.Assignable<Tutorial.DerivedClass>(L, 2))
                {
                    Tutorial.DerivedClass leftside =
                        (Tutorial.DerivedClass)translator.GetObject(L, 1, typeof(Tutorial.DerivedClass));
                    Tutorial.DerivedClass rightside =
                        (Tutorial.DerivedClass)translator.GetObject(L, 2, typeof(Tutorial.DerivedClass));
