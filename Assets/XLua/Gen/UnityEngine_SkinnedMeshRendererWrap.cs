...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineSkinnedMeshRendererWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "forceMatrixRecalculationPerRender",
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "forceMatrixRecalculationPerRender",
        ...
        static int _m_BakeMesh(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 3 && translator.Assignable<UnityEngine.Mesh>(L, 2) &&
