    ...
    public class UnityEngineVector2Wrap
    {
        ...
        static int __AddMeta(RealStatePtr L)
        {
            try
            {
                ...
                if (translator.Assignable<UnityEngine.Vector2>(L, 1) &&
        ...
        static int _m_SmoothDamp_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 4 && translator.Assignable<UnityEngine.Vector2>(L, 1) &&
                    translator.Assignable<UnityEngine.Vector2>(L, 2) &&
                    translator.Assignable<UnityEngine.Vector2>(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4))
                {
                    UnityEngine.Vector2 _current;
                    translator.Get(L, 1, out _current);
                    UnityEngine.Vector2 _target;
                ...
                if (gen_param_count == 5 && translator.Assignable<UnityEngine.Vector2>(L, 1) &&
                    translator.Assignable<UnityEngine.Vector2>(L, 2) &&
                    translator.Assignable<UnityEngine.Vector2>(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) &&
                ...
                if (gen_param_count == 6 && translator.Assignable<UnityEngine.Vector2>(L, 1) &&
                    translator.Assignable<UnityEngine.Vector2>(L, 2) &&
                    translator.Assignable<UnityEngine.Vector2>(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) &&
