...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimationCurveWrap
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
                if (LuaAPI.lua_gettop(L) >= 1 && (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 2) ||
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
            try
            {
                ...
                if (translator.Assignable<UnityEngine.AnimationCurve>(L, 1) &&
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
                {
                    UnityEngine.AnimationCurve gen_to_be_invoked =
                        (UnityEngine.AnimationCurve)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Equals(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.AnimationCurve _other =
                        (UnityEngine.AnimationCurve)translator.GetObject(L, 2, typeof(UnityEngine.AnimationCurve));
        ...
        static int _s_set_keys(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.AnimationCurve gen_to_be_invoked =
                    (UnityEngine.AnimationCurve)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.keys =
                    (UnityEngine.Keyframe[])translator.GetObject(L, 2, typeof(UnityEngine.Keyframe[]));
            }
            catch (System.Exception gen_e)
            {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
