    ...
    public class UnityEngineObjectWrap
    {
        ...
        static int __EqMeta(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Object leftside =
                        (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
                    UnityEngine.Object rightside =
                        (UnityEngine.Object)translator.GetObject(L, 2, typeof(UnityEngine.Object));
        ...
        static int _m_InstantiateAsync_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 2 && translator.Assignable<UnityEngine.Object>(L, 1) &&
                    ...
                    translator.Assignable<UnityEngine.Transform>(L, 2))
                {
                    ...
                    UnityEngine.Transform _parent =
                        (UnityEngine.Transform)translator.GetObject(L, 2, typeof(UnityEngine.Transform));
                ...
                if (gen_param_count == 3 && translator.Assignable<UnityEngine.Object>(L, 1) &&
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<UnityEngine.Transform>(L, 3))
                {
                    UnityEngine.Object _original =
                        (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
                    int _count = LuaAPI.xlua_tointeger(L, 2);
                    UnityEngine.Transform _parent =
                        (UnityEngine.Transform)translator.GetObject(L, 3, typeof(UnityEngine.Transform));
                ...
                if (gen_param_count == 4 && translator.Assignable<UnityEngine.Object>(L, 1) &&
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<UnityEngine.Vector3>(L, 3) &&
                    translator.Assignable<UnityEngine.Quaternion>(L, 4))
                {
                    UnityEngine.Object _original =
                        (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
                    int _count = LuaAPI.xlua_tointeger(L, 2);
                    UnityEngine.Vector3 _position;
                    translator.Get(L, 3, out _position);
                    UnityEngine.Quaternion _rotation;
                    translator.Get(L, 4, out _rotation);
                ...
                if (gen_param_count == 5 && translator.Assignable<UnityEngine.Object>(L, 1) &&
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) &&
                    translator.Assignable<UnityEngine.Transform>(L, 3) &&
                    translator.Assignable<UnityEngine.Vector3>(L, 4) &&
                    translator.Assignable<UnityEngine.Quaternion>(L, 5))
                {
                    UnityEngine.Object _original =
                        (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
                    int _count = LuaAPI.xlua_tointeger(L, 2);
                    UnityEngine.Transform _parent =
                        (UnityEngine.Transform)translator.GetObject(L, 3, typeof(UnityEngine.Transform));
                    UnityEngine.Vector3 _position;
                    translator.Get(L, 4, out _position);
                    UnityEngine.Quaternion _rotation;
                    translator.Get(L, 5, out _rotation);
        ...
        static int _m_Instantiate_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 2 && translator.Assignable<UnityEngine.Object>(L, 1) &&
                    translator.Assignable<UnityEngine.SceneManagement.Scene>(L, 2))
                {
                    UnityEngine.Object _original =
                        (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
                    UnityEngine.SceneManagement.Scene _scene;
                    translator.Get(L, 2, out _scene);
                    ...
                    translator.Assignable<UnityEngine.Transform>(L, 4))
                {
                    ...
                    translator.Get(L, 3, out _rotation);
                    UnityEngine.Transform _parent =
                        (UnityEngine.Transform)translator.GetObject(L, 4, typeof(UnityEngine.Transform));
        ...
        static int _m_FindObjectsOfType_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 2 && translator.Assignable<System.Type>(L, 1) &&
                    LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2))
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
        ...
        static int _m_FindObjectsByType_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 2 && translator.Assignable<System.Type>(L, 1) &&
                    translator.Assignable<UnityEngine.FindObjectsSortMode>(L, 2))
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                    UnityEngine.FindObjectsSortMode _sortMode;
                    translator.Get(L, 2, out _sortMode);
                ...
                if (gen_param_count == 3 && translator.Assignable<System.Type>(L, 1) &&
                    translator.Assignable<UnityEngine.FindObjectsInactive>(L, 2) &&
                    translator.Assignable<UnityEngine.FindObjectsSortMode>(L, 3))
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                    UnityEngine.FindObjectsInactive _findObjectsInactive;
                    translator.Get(L, 2, out _findObjectsInactive);
                    UnityEngine.FindObjectsSortMode _sortMode;
                    translator.Get(L, 3, out _sortMode);
