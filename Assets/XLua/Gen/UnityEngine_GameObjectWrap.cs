    ...
    public class UnityEngineGameObjectWrap
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            try
            {
                ...
                if (LuaAPI.lua_gettop(L) >= 2 &&
                    (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) &&
                    (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 3) || translator.Assignable<System.Type>(L, 3)))
                {
                    string _name = LuaAPI.lua_tostring(L, 2);
        ...
        static int _m_GetComponentInChildren(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 3 && translator.Assignable<System.Type>(L, 2) &&
        ...
        static int _m_GetComponents(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 3 && translator.Assignable<System.Type>(L, 2) &&
                    translator.Assignable<System.Collections.Generic.List<UnityEngine.Component>>(L, 3))
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                    System.Collections.Generic.List<UnityEngine.Component> _results =
                        (System.Collections.Generic.List<UnityEngine.Component>)translator.GetObject(L, 3,
        ...
        static int _m_SendMessageUpwards(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 3 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) &&
                ...
                if (gen_param_count == 4 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) &&
                    translator.Assignable<object>(L, 3) && translator.Assignable<UnityEngine.SendMessageOptions>(L, 4))
                {
                    string _methodName = LuaAPI.lua_tostring(L, 2);
                    object _value = translator.GetObject(L, 3, typeof(object));
                    UnityEngine.SendMessageOptions _options;
        ...
        static int _m_GetComponentIndex(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Component _component =
                        (UnityEngine.Component)translator.GetObject(L, 2, typeof(UnityEngine.Component));
        ...
        static int _m_InstantiateGameObjects_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 5 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1) &&
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) &&
                    translator.Assignable<Unity.Collections.NativeArray<int>>(L, 3) &&
                    translator.Assignable<Unity.Collections.NativeArray<int>>(L, 4) &&
                    translator.Assignable<UnityEngine.SceneManagement.Scene>(L, 5))
                {
                    int _sourceInstanceID = LuaAPI.xlua_tointeger(L, 1);
                    int _count = LuaAPI.xlua_tointeger(L, 2);
                    Unity.Collections.NativeArray<int> _newInstanceIDs;
                    translator.Get(L, 3, out _newInstanceIDs);
                    Unity.Collections.NativeArray<int> _newTransformInstanceIDs;
                    translator.Get(L, 4, out _newTransformInstanceIDs);
                    UnityEngine.SceneManagement.Scene _destinationScene;
                    translator.Get(L, 5, out _destinationScene);

                    UnityEngine.GameObject.InstantiateGameObjects(_sourceInstanceID, _count, _newInstanceIDs,
                        _newTransformInstanceIDs, _destinationScene);


                    return 0;
                }

                if (gen_param_count == 4 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1) &&
                    LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) &&
                    translator.Assignable<Unity.Collections.NativeArray<int>>(L, 3) &&
                    translator.Assignable<Unity.Collections.NativeArray<int>>(L, 4))
                {
