...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
        ...
        public XLuaTest.InvokeLua.ICalc __Gen_Delegate_Imp13(int p0, string[] p1)
        {
            ...
            if (p1 != null)
            {
                for (int __gen_i = 0; __gen_i < p1.Length; ++__gen_i) LuaAPI.lua_pushstring(L, p1[__gen_i]);
            }
            ...
            XLuaTest.InvokeLua.ICalc __gen_ret =
                (XLuaTest.InvokeLua.ICalc)translator.GetObject(L, errFunc + 1, typeof(XLuaTest.InvokeLua.ICalc));
            LuaAPI.lua_settop(L, errFunc - 1);
            return __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
        ...
        public UnityEngine.GameObject __Gen_Delegate_Imp21(XLuaTest.StructTest p0, int p1, object p2)
        {
            ...
            UnityEngine.GameObject __gen_ret =
                (UnityEngine.GameObject)translator.GetObject(L, errFunc + 1, typeof(UnityEngine.GameObject));
            LuaAPI.lua_settop(L, errFunc - 1);
            return __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
