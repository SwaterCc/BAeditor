...
namespace Sirenix.OdinInspector.Demos.RPGEditor
{
    ...
    public abstract class Item : ScriptableObject
    {
        ...
        [BoxGroup(LEFT_VERTICAL_GROUP + "/General Settings")] [VerticalGroup(GENERAL_SETTINGS_VERTICAL_GROUP)]
        public string Name;

        [BoxGroup("Split/Right/Description")] [HideLabel, TextArea(4, 14)]
        ...
        [VerticalGroup("Split/Right")] public StatList Requirements;

        [AssetsOnly] [VerticalGroup(GENERAL_SETTINGS_VERTICAL_GROUP)]
        public GameObject Prefab;

        [BoxGroup(STATS_BOX_GROUP)] public int ItemStackSize = 1;

        [BoxGroup(STATS_BOX_GROUP)] public float ItemRarity;
