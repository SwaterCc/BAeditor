...
namespace Hono.Scripts.Battle.Core {
	...
	public abstract class Unit {
		...
		public void Init() {
			EventManager.Instance.AddCollection(Uid, _evtListenerCollection);
		...
		public void AddUnitEvtListener(EventListener eventListener) {
			_evtListenerCollection.AddListener(eventListener,false);
		}
		...
		/// </summary>
		/// <param name="eventListener"></param>
		public void AddWorldEvtListener(EventListener eventListener) {
			_evtListenerCollection.AddListener(eventListener,true);
		}
		...
		/// </summary>
		/// <param name="eventListener"></param>
		public void RemoveUnitEvtListener(EventListener eventListener) {
