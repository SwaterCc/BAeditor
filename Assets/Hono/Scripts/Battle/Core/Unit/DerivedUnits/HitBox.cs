        ...
        private void Hit()
        {
            ...
            switch (_hitBoxType)
            {
                case HitBoxType.LockTargetSingleHit:
                    ...
                    _attacker.SingleHit(_target, _sourceType, _sourceAbilityId, _disableEventTrigger, _damageId);
                    break;
                case HitBoxType.LockTargetAreaHit:
                    if (_target == null) return;
                    _attacker.AreaHit(_target.UnitTransform.Pos, _target.UnitTransform.YAxisAngle, _sourceType,
                                      _sourceAbilityId, _aoeSetting, _disableEventTrigger, _damageId);
                    break;
                case HitBoxType.HitArea:
                    _attacker.AreaHit(UnitTransform.Pos, UnitTransform.YAxisAngle, _sourceType, _sourceAbilityId,
