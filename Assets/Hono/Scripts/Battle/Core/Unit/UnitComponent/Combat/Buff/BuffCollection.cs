    ...
    public partial class CombatComp
    {
        ...
        private class BuffController
        {
            ...
            public BuffController(CombatComp combatComp, int capacity = 30)
            {
                ...
                _lookup = new Dictionary<int, int>(capacity); // 初始化字典
            }
            ...
            /// <param name="buffData">buff配置</param>
            public int AddBuff(int sourceId, int buffId, int buffLayer, BuffData buffData)
            {
                //阻断判断
