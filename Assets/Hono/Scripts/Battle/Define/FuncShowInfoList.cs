...
namespace Hono.Scripts.Battle
{
    public class ParamShowInfo
    {
	    ...
	    ///     类型，反射产生
	    /// </summary>
	    [LabelText("参数类型")] public string Type;

	    /// <summary>
	    ///     反射产生
	    /// </summary>
	    [LabelText("参数命名")] public string Name;

	    /// <summary>
	    ///     描述，手填字段
	    /// </summary>
	    [LabelText("参数描述")] public string Desc;
    }

    public class FuncShowInfo
    {
        [LabelText("函数名")] public string FuncName;

        [LabelText("函数描述")] public string FuncDesc;

        [LabelText("返回值类型")] public string ReturnType;

        public int OverloadTag;

        [LabelText("参数列表")] public List<ParamShowInfo> Params = new List<ParamShowInfo>();
    }
