...
namespace Hono.Scripts.Battle.Editor
{
    ...
    public class PathCollector
    {
        ...
        {
            _resPaths = AssetDatabase.LoadAssetAtPath<Paths>("Assets/BattleData/Paths.asset");
        }

        public void CollectPath()
        {
            _resPaths.paths.Clear();
            ...
            _resPaths.paths.Add(EPathType.CSV, csvPaths);

            //ability
            if (TryGetAllAssetPaths(BattleConstValue.AbilityRoot, out var abilityPaths))
            {
                _resPaths.paths.Add(EPathType.Ability, abilityPaths);
            }
            else
            {
            ...
            {
                _resPaths.paths.Add(EPathType.Skill, skillPaths);
            }
            else
            {
            ...
            {
                _resPaths.paths.Add(EPathType.Buff, buffPaths);
            }
            else
            {
            ...
            {
                _resPaths.paths.Add(EPathType.Bullet, bulletsPaths);
            }
            else
            {
            ...
            EditorUtility.SetDirty(_resPaths);
