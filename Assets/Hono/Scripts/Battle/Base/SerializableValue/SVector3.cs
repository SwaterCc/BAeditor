...
namespace Hono.Scripts.Battle {
	...
	public struct SVector3 {
		...
		// 重载运算符，用于隐式转换
		public static implicit operator Vector3(SVector3 wrapper) {
		...
		// 方法：向量数乘
		public static SVector3 operator *(SVector3 a, float scalar) {
			return new SVector3(a.x * scalar, a.y * scalar, a.z * scalar);
		}
