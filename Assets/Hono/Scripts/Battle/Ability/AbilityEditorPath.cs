...
{
    public static class AbilityEditorPath
    {
        public static readonly string RootPath = "Assets/BattleData";

        public static readonly string AbilitySkillPath = $"{RootPath}/Ability/Skill";
        public static readonly string AbilityBuffPath = $"{RootPath}/Ability/Buff";
