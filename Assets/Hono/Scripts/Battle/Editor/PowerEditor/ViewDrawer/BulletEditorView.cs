...
{
    public class BulletEditorView : AView<BulletData>
    {
        ...
        private void drawBullet()
        {
            ...
            else
            {
                ...
                Data.hitVFXStr = PowerEditorUIHelper.DrawObjectField<GameObject>("子弹命中时的特效",  Data.hitVFXStr);
                Data.deadVFXStr = PowerEditorUIHelper.DrawObjectField<GameObject>("子弹销毁时的特效", Data.deadVFXStr);
            }
        ...
        public class BulletViewDrawer : AViewDrawer<BulletEditorView> { }
    }
}