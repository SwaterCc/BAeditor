...
{
    public class AttrSetterTreeItem : ATreeItem
    {
        private new AttrNodeData _nodeData;

        public AttrSetterTreeItem(AbilityCycleTree tree, AbilityNodeData data) : base(tree, data)
        {
        ...
        protected override void OnBtnClicked(Rect btnRect)
        {
            ...
            SettingWindow = NodeWindowBase<AttrSetterWindow, AttrNodeData>.GetSettingWindow(Tree.TreeData,
                _nodeData,
    ...
    public class AttrSetterWindow : NodeWindowBase<AttrSetterWindow, AttrNodeData>,
