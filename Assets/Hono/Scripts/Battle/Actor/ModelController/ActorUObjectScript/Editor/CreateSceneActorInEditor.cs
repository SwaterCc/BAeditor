...
namespace Hono.Scripts.Battle.Editor {
	public static class CreateSceneActorInEditor {
		...
		[MenuItem("GameObject/战斗工具/队伍放置区域",false,10)]
		private static void createTeamRefreshArea() {
			CreatePrefab("Assets/BattleData/GameTestRes/TestModel/TeamPointArea.prefab");
		}
